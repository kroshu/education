...
class GetAgeClient(Node):
    ...
    def __init__(self):
        ...
        self.birth_date = self.get_parameter('birth_date').get_parameter_value().string_value
    ...
    def send_request(self):
        self.logger.info(f'Sending request to get_age service with birth date: {self.birth_date}')
